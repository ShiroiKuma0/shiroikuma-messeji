...
non-`org.fossify.*` consumers, hiding the Contacts app's shared private/local contacts from this app.
Fixed in the commons fork as of `-sk2` — nothing to change in this repo beyond the pin.
