...
description: Rebase our fork onto a new upstream release of FossifyOrg/Messages. Use when the user says a new upstream version is out, asks to update/sync to upstream, bump to the new Messages release, or rebase custom onto the latest upstream.
---
